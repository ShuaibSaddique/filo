		...
		if ($e == false) {
			try {
				...
				if (($usersfound > 0) && ($staff == 1)) {					
					header('Location: http://localhost/projects/uni/coursework/staffhome.php');
					$_SESSION["username"] = $username;
				}
				elseif (($usersfound > 0) && ($staff == 0)) {					
					header('Location: http://localhost/projects/uni/coursework/userhome.php');
					$_SESSION["username"] = $username;
				}
				else {
				...
				<form method = "post" action="login.php">
					...
					<br><br><br>
					Don't have an account? <a href="http://localhost/projects/uni/coursework/register.php"><em>Click here to register.</em></a>
				</form>
				<?php
