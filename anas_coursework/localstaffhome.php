...
if (!isset($_SESSION["username"])) {
	...
	header('Refresh: 2; http://localhost/projects/uni/coursework/logout.php') ;	
}
else {
	if ($_SESSION["staff"] == 0) {
		echo "You do not have permission to access this page!";
		header('Refresh: 2; http://localhost/projects/uni/coursework/userhome.php') ;	
	}
	else {
	...
	<div id="logout">
	Logged in as <strong><em> <?php echo $username ?> </em></strong>&nbsp; | &nbsp; <a href=http://localhost/projects/uni/coursework/logout.php ><strong>Logout</strong></a>
	</div>
	<body>
